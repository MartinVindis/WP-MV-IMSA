...
pos=(0.775,0.0,-1.420) ori=(0.0,0.0,0.0)
...
pos=(0.830,0.0,-1.420) ori=(0.0,0.0,0.0)
...
pos=(0.755,0.0,1.40) ori=(0.0,0.0,0.0)
...
pos=(0.810,0.0,1.40) ori=(0.0,0.0,0.0)
...
[JOINT&HINGE]
posbody=fl_wheel negbody=fl_spindle pos=fl_wheel axis=(-0.830,0.0,0.0)

[JOINT&HINGE]
posbody=fr_wheel negbody=fr_spindle pos=fr_wheel axis=(0.830,0.0,0.0)

// Front left suspension (2 A-arms + 1 steering arm = 5 links)
[BAR] // forward upper arm
name=fl_fore_upper posbody=body negbody=fl_spindle pos=(0.140,0.075,-1.480) neg=(0.730,0.105,-1.420)

[BAR] // rearward upper arm
posbody=body negbody=fl_spindle pos=(0.140,0.075,-1.170) neg=(0.730,0.105,-1.420)

[BAR] // forward lower arm
posbody=body negbody=fl_spindle pos=(0.05,-0.120,-1.510) neg=(0.730,-0.115,-1.420)

[BAR] // rearward lower arm
name=fl_fore_lower posbody=body negbody=fl_spindle pos=(0.05,-0.120,-1.140) neg=(0.730,-0.115,-1.420)

[BAR] // steering arm (must be named for identification)
name=fl_steering posbody=body negbody=fl_spindle pos=(0.14,0.075,-1.540) neg=(0.730,0.105,-1.490)

// Front right suspension (2 A-arms + 1 steering arm = 5 links)
[BAR] // forward upper arm
name=fr_fore_upper posbody=body negbody=fr_spindle pos=(-0.140,0.075,-1.480) neg=(-0.730,0.105,-1.420)

[BAR] // rearward upper arm
posbody=body negbody=fr_spindle pos=(-0.140,0.075,-1.170) neg=(-0.730,0.105,-1.420)

[BAR] // forward lower arm
posbody=body negbody=fr_spindle pos=(-0.05,-0.120,-1.510) neg=(-0.730,-0.115,-1.420)

[BAR] // rearward lower arm
name=fr_fore_lower posbody=body negbody=fr_spindle pos=(-0.05,-0.120,-1.140) neg=(-0.730,-0.115,-1.420)

[BAR] // steering arm (must be named for identification)
name=fr_steering posbody=body negbody=fr_spindle pos=(-0.14,0.075,-1.540) neg=(-0.730,0.105,-1.490)

// Rear left suspension (2 A-arms + 1 straight link = 5 links)
[BAR] // forward upper arm
posbody=body negbody=rl_spindle pos=(0.100,0.098,1.10) neg=(0.740,0.105,1.40)

[BAR] // rearward upper arm
posbody=body negbody=rl_spindle pos=(0.100,0.098,1.50) neg=(0.740,0.105,1.40)

[BAR] // forward lower arm
posbody=body negbody=rl_spindle pos=(0.050,-0.09,1.10) neg=(0.740,-0.105,1.40)

[BAR] // rearward lower arm
posbody=body negbody=rl_spindle pos=(0.050,-0.09,1.50) neg=(0.740,-0.105,1.40)

[BAR] // straight link
posbody=body negbody=rl_spindle pos=(0.050,0.0215,1.60) neg=(0.740,0.02,1.60)

// Rear right suspension (2 A-arms + 1 straight link = 5 links)
[BAR] // forward upper arm
posbody=body negbody=rr_spindle pos=(-0.100,0.098,1.10) neg=(-0.740,0.105,1.40)

[BAR] // rearward upper arm
posbody=body negbody=rr_spindle pos=(-0.100,0.098,1.50) neg=(-0.740,0.105,1.40)

[BAR] // forward lower arm
posbody=body negbody=rr_spindle pos=(-0.050,-0.09,1.10) neg=(-0.740,-0.105,1.40)

[BAR] // rearward lower arm
posbody=body negbody=rr_spindle pos=(-0.050,-0.09,1.50) neg=(-0.740,-0.105,1.40)

[BAR] // straight link
posbody=body negbody=rr_spindle pos=(-0.050,0.0215,1.60) neg=(-0.740,0.02,1.60)
