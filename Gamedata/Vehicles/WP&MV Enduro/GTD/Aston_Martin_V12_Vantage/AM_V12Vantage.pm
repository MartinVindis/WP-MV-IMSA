...
pos=(0.770,0.0,-1.302) ori=(0.0,0.0,0.0)
...
pos=(0.790,0.0,-1.302) ori=(0.0,0.0,0.0)
...
pos=(0.76,0.0,1.302) ori=(0.0,0.0,0.0)
...
pos=(0.795,0.0,1.302) ori=(0.0,0.0,0.0)
...
name=fl_fore_upper posbody=body negbody=fl_spindle pos=(0.502,0.050,-1.370) neg=(0.766,0.070,-1.302)

[BAR] // rearward upper arm
posbody=body negbody=fl_spindle pos=(0.502,0.050,-1.170) neg=(0.766,0.070,-1.302)

[BAR] // forward lower arm
posbody=body negbody=fl_spindle pos=(0.460,-0.088,-1.370) neg=(0.772,-0.068,-1.302)

[BAR] // rearward lower arm
name=fl_fore_lower posbody=body negbody=fl_spindle pos=(0.460,-0.088,-1.120) neg=(0.772,-0.068,-1.302)

[BAR] // steering arm (must be named for identification)
name=fl_steering posbody=body negbody=fl_spindle pos=(0.394,-0.005,-1.510) neg=(0.762,-0.005,-1.510)

// Front right suspension (2 A-arms + 1 steering arm = 5 links)
[BAR] // forward upper arm (used in steering lock calculation)
name=fr_fore_upper posbody=body negbody=fr_spindle pos=(-0.502,0.050,-1.370) neg=(-0.766,0.070,-1.302)

[BAR] // rearward upper arm
posbody=body negbody=fr_spindle pos=(-0.502,0.050,-1.170) neg=(-0.766,0.070,-1.302)

[BAR] // forward lower arm
name=fr_fore_lower posbody=body negbody=fr_spindle pos=(-0.460,-0.088,-1.370) neg=(-0.772,-0.068,-1.302)

[BAR] // rearward lower arm
posbody=body negbody=fr_spindle pos=(-0.460,-0.088,-1.120) neg=(-0.772,-0.068,-1.302)

[BAR] // steering arm (must be named for identification)
name=fr_steering posbody=body negbody=fr_spindle pos=(-0.394,-0.005,-1.510) neg=(-0.762,-0.005,-1.510)

// Rear left suspension (2 A-arms + 1 straight link = 5 links)
[BAR] // forward upper arm
posbody=body negbody=rl_spindle pos=(0.500,0.060,1.170) neg=(0.742,0.068,1.302)

[BAR] // rearward upper arm
posbody=body negbody=rl_spindle pos=(0.500,0.060,1.420) neg=(0.742,0.068,1.302)

[BAR] // forward lower arm
posbody=body negbody=rl_spindle pos=(0.430,-0.067,1.170) neg=(0.740,-0.065,1.302)

[BAR] // rearward lower arm
posbody=body negbody=rl_spindle pos=(0.430,-0.067,1.420) neg=(0.740,-0.065,1.302)

[BAR] // straight link
posbody=body negbody=rl_spindle pos=(0.420,0.015,1.560) neg=(0.776,0.008,1.560)

// Rear right suspension (2 A-arms + 1 straight link = 5 links)
[BAR] // forward upper arm
posbody=body negbody=rr_spindle pos=(-0.500,0.060,1.170) neg=(-0.742,0.068,1.302)

[BAR] // rearward upper arm
posbody=body negbody=rr_spindle pos=(-0.500,0.060,1.420) neg=(-0.742,0.068,1.302)

[BAR] // forward lower arm
posbody=body negbody=rr_spindle pos=(-0.430,-0.067,1.170) neg=(-0.740,-0.065,1.302)

[BAR] // rearward lower arm
posbody=body negbody=rr_spindle pos=(-0.430,-0.067,1.420) neg=(-0.740,-0.065,1.302)

[BAR] // straight link
posbody=body negbody=rr_spindle pos=(-0.420,0.015,1.560) neg=(-0.776,0.008,1.560)
